...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::google_drive_locations,
            ...
            commands::transfer_jobs_list,
            commands::transfer_log_list,
            commands::transfer_log_clear,
            commands::transfer_job_delete,
            commands::transfer_jobs_clear,
            ...
            commands::workspace_compare_checksum,
            commands::workspace_compare_snapshot,
            commands::workspace_prepare_destination,
            ...
            commands::local_default_directory,
            commands::local_directory_list,
